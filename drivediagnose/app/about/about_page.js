    ...
    <>
      ...
      <section className="py-20">
        <div className="container-md">
          ...
          {/* Paste your YouTube embed URL here when ready */}
          <div className="max-w-3xl mx-auto rounded-2xl border-2 border-dashed border-gray-200 aspect-video bg-gray-50 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-xs mt-1">Replace this placeholder in app/about/page.js</p>
          </div>
        </div>
      </section>
